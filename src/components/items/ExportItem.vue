  ...
  methods: {
    exportItem: function(e) {
      ...
      for (var i in this.position_data.positions) {
        if (
          new Date(this.position_data.positions[i].doc.timestamp) >
            new Date(this.start_time) &&
          new Date(this.position_data.positions[i].doc.timestamp) <
            new Date(this.stop_time)
        ) {
          var item = [];
          if (
            typeof this.position_data.positions[i].doc.timestamp !== 'undefined'
          )
          ...
          if (
            typeof this.position_data.positions[i].doc.heading !== 'undefined'
          )
            item.push(
              this.position_data.positions[i].doc.heading !== 'undefined'
            );
          if (typeof this.position_data.positions[i].doc.speed !== 'undefined')
            item.push(
              this.position_data.positions[i].doc.speed !== 'undefined'
            );
          data.push(item);
        }
      }
